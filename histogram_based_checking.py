...
def solve(img, key, bbox):
    ...
    if drawing[key[1] - bbox[1]][key[0] - bbox[0]] == 255:
        val = 1
        reduction = 100 - cv2.countNonZero(drawing) * 1.0 / (h * w) * 100
...
# filenames = ['/home/aman/number_plate_detector/dataset/vlcsnap-2019-02-18-01h04m09s067.png']
count = 0
...
for filename in filenames:
    ...
    if file_extension == '.png':
        ...
        cv2.imshow("img", img)
        val, reduction = solve(roi, key, bbox)
